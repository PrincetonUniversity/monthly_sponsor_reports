...
(base) $ python -m unittest tests/test_monthly_sponsor_reports.py -v
```

If the tests all pass then do a dry run (which takes a few minutes):

```
(base) $ python monthly_sponsor_reports.py --start 2021-11-01 --end 2022-01-31
```
...
```
(base) $ python monthly_sponsor_reports.py --start 2021-11-01 --end 2022-01-31 --email
```
